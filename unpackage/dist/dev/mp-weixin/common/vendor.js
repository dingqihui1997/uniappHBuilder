...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"youpin si","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 11:
/*!**********************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/http/api.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _index = _interopRequireDefault(__webpack_require__(/*! ./index.js */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =


{
  // 获取搜索推荐关键词
  // query	string	是
  getSuggest: function getSuggest(query) {
    return _index.default.get("/Search/suggest?query=".concat(query));
  },
  // 获取搜索输入框占位词
  getHotWords: function getHotWords() {
    return _index.default.get("/Search/hotWords");
  },
  // 获取可用优惠券数量
  getCouponCount: function getCouponCount() {
    return _index.default.get("/User/couponCount");
  },
  // 更新记录
  // data.type	0新增 1优化 2修复
  getUpdateHistory: function getUpdateHistory(type) {
    return _index.default.get("/User/updateHistory?type=".concat(type));
  },
  // 获取用户优惠券
  // type	string	是	类型 0可用 1不可用
  getCoupon: function getCoupon(type) {
    return _index.default.get("/User/coupon?type$={type}");
  },
  // 推荐文章
  // uuid	string	是	当前文章ID
  // page	string	是	页数
  // pageSize	string	是	数据条数
  getSimilarFeed: function getSimilarFeed(uuid, page, pageSize) {
    return _index.default.get("/Life/getSimilarFeed?uuid=".concat(uuid, "&page=").concat(page, "&pageSize=").concat(pageSize));
  },
  // 文章详情
  // uuid	string	是	文章ID
  getDetail: function getDetail(uuid) {
    return _index.default.get("/Life/detail?uuid=".concat(uuid));
  },
  // 生活板块
  // tab	string	是	tabID
  // page	string	是	页数
  // pageSize	string	是	数据条数
  getHomeTab: function getHomeTab(tab, page, pageSize) {
    return _index.default.get("/Life/getHomeTab?tab=".concat(tab, "&page=").concat(page, "&pageSize=").concat(pageSize));
  },
  // 生活首页数据
  getBktrSimple: function getBktrSimple() {
    return _index.default.get("/Life/bktrSimple");
  },
  // 商品详情图
  // gid	string	是
  // title	string	是
  // type	string	是
  getLifeDetailImg: function getLifeDetailImg(gid, title, type) {
    return _index.default.get("/Life/getHomeTab?gid=".concat(gid, "&title=").concat(title, "&type=").concat(type));
  },
  // 分类获取商品列表
  getQueryIdSearch: function getQueryIdSearch() {
    return _index.default.post("/Goods/queryIdSearch");
  },
  // 搜索获取商品列表
  getDoSearch: function getDoSearch() {
    return _index.default.post("/Goods/doSearch");
  },
  // 视频时长
  // file	string	是
  getGetTime: function getGetTime(file) {
    return _index.default.get("/Common/getTime?file=".concat(file));
  },
  // 获取更多问答列表
  // gid	string	是
  getAskInfo: function getAskInfo(gid) {
    return _index.default.get("/Goods/askInfo?gid=".concat(gid));
  },
  // 通过评价标签获取评价列表
  // gid	string	是
  // page	string	是
  // pageSize	string	是
  // tagId	string	是
  getCommentContent: function getCommentContent(gid, page, pageSize, tagId) {
    return _index.default.get("/Goods/commentContent?gid=".concat(gid, "&page=").concat(page, "&pageSize=").concat(pageSize, "&tagId=").concat(tagId));
  },
  // 获取更多评价标签
  // gid	string	是
  getCommentTag: function getCommentTag(gid) {
    return _index.default.get("/Goods/commentTag?gid=".concat(gid));
  },
  // 详情页推荐商品-排行榜-问答
  // gid	string	是
  getComposeTwo: function getComposeTwo(gid) {
    return _index.default.get("/Goods/composeTwo?gid=".concat(gid));
  },
  // 获取商品详情图
  // type	string	是
  // gid	string	是
  // title	string	是
  getDetailImg: function getDetailImg(type, gid, title) {
    return _index.default.get("/Goods/detailImg?type=".concat(type, "&gid=").concat(gid, "&title=").concat(title));
  },
  // 商品详情
  // gid	string	是
  getGoodsDetail: function getGoodsDetail(gid) {
    return _index.default.get("/Goods/detail?gid=".concat(gid));
  },
  // 按商品ID查询商品
  // gids	string	是
  getGoodsQueryByGids: function getGoodsQueryByGids(_ref)

  {var gids = _ref.gids;
    return _index.default.post("/Goods/queryByGids");
  },
  // 推荐商品
  // type	string	是
  // offset	string	是
  // limit	string	是
  // gid_list	string	是
  getRecommend: function getRecommend(offset) {
    return _index.default.get("/Goods/recommend?type=7&offset=".concat(offset, "&limit=6"));
  },
  // 通过一级分类获取二级分类
  // catId	string	是
  getCategorydetail: function getCategorydetail(catId) {
    return _index.default.get("/Category/detail?catId=".concat(catId));
  },
  // 一级分类
  getCategorylist: function getCategorylist() {
    return _index.default.get("/Category/list");
  },
  // BEST商品列表
  getBestGoods: function getBestGoods() {
    return _index.default.post("/HomePage/bestGoods");
  },
  // APP首页数据
  // User-Agent	string	是
  getAppHomeData: function getAppHomeData(Agent) {
    return _index.default.get("/HomePage/appHomeData?Agent=".concat(Agent));
  },
  // BEST
  getHomePagebest: function getHomePagebest() {
    return _index.default.get("/HomePage/best");
  },
  // 总榜商品列表
  // offset	string	是
  // limit	string	是
  getTopGoodsList: function getTopGoodsList(offset, limit) {
    return _index.default.get("/HomePage/topGoodsList?offset=".concat(offset, "&limit=").concat(limit));
  },
  // 总榜
  getTopList: function getTopList() {
    return _index.default.get("/HomePage/topList");
  },
  // 直播列表
  getLive: function getLive() {
    return _index.default.get("/HomePage/live");
  },
  // 秒杀
  ...
  getSeckill: function getSeckill(offset, limit, plan_id, type) {
    return _index.default.get("/HomePage/seckill?offset=".concat(offset, "&limit=").concat(limit, "&plan_id=").concat(plan_id, "&type=").concat(type));
  },
  // 众筹
  getCrowdfunding: function getCrowdfunding() {
    return _index.default.get("/HomePage/crowdfunding");
  },
  // 每日上新
  getNew: function getNew() {
    return _index.default.get("/HomePage/new");
  },
  // 按分类获取首页底部商品列表
  // index	string	是	页数
  // query_id	string	是
  getFeeds: function getFeeds(index, query_id) {
    return _index.default.get("/HomePage/feeds?index=".concat(index, "&query_id=").concat(query_id));
  },
  // 首页数据
  getHomeData: function getHomeData() {
    return _index.default.get("/HomePage/homeData");
  },
  // 测试
  getYiyan: function getYiyan() {
    return _index.default.get("/HomePage/yiyan");
  },
  //sortBy: 综合排序传0 销量排序传8  新品传7 价格降序传2 价格升序传1 信用排序传6 
  queryIdSearch: function queryIdSearch(query, sortBy, source) {
    return _index.default.post('/Goods/doSearch', {
      filter: {
        attr: [],
        brands: [],
...
/***/ 12:
/*!************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/http/index.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _wx = _interopRequireDefault(__webpack_require__(/*! flyio/dist/npm/wx */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 14:
/*!*************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/store/index.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var num = uni.getStorageSync('Cart').length;
var store = new _vuex.default.Store({
  state: { //共享数据
    badge: num //
  },
  mutations: { //修改
    setBadge: function setBadge(state, data) {
      state.badge = data;
    } },
...
/***/ 16:
/*!*****************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/index.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 17:
/*!****************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/mixin/mixin.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 18:
/*!******************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/request/index.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 19:
/*!***********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/deepMerge.js ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 20:
/*!***********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/deepClone.js ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 21:
/*!******************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/test.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 22:
/*!*************************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/queryParams.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 23:
/*!*******************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/route.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 27:
/*!************************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/timeFormat.js ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 28:
/*!**********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/timeFrom.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 29:
/*!***************************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/colorGradient.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 30:
/*!******************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/guid.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 31:
/*!*******************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/color.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 32:
/*!***********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/type2icon.js ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 33:
/*!*************************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/randomArray.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 34:
/*!*********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/addUnit.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 35:
/*!********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/random.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 36:
/*!******************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/trim.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 37:
/*!*******************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/toast.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 38:
/*!***********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/getParent.js ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 39:
/*!*********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/$parent.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!*********************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/pages.json ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 40:
/*!*****************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/sys.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 41:
/*!**********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/debounce.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 42:
/*!**********************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/function/throttle.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 43:
/*!******************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/config/config.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 44:
/*!******************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/config/zIndex.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 45:
/*!*************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/utils/index.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} //模块化导入和导出
var _default =
{
  // 检测用户是否登录了
  //next函数需要的参数item
  ...
  // key:储存的历史
  // attr:判断元素是否存在的属性名
  saveHistory: function saveHistory(_ref)



  {var key = _ref.key,data = _ref.data,attr = _ref.attr;
    // 如果是其余的数据 判断的属性可能就不叫name了

    // 拼接一个名字
    var name = key + 'History';
    var history = uni.getStorageSync(name);
    if (history) {
      // 之前已经存储过了
      var arr = uni.getStorageSync(name);
      // 检测数据是否已经存在
      var item = null;
      if (typeof data === 'string') {
        item = arr.find(function (i) {
          return i[attr] === data;
        });
      } else {
        item = arr.find(function (i) {
      ...
      uni.setStorageSync(name, _arr);
    }
  },
  // 获取存储记录
  getHistory: function getHistory(_ref2)

  {var key = _ref2.key;
    var name = key + 'History';
    var arr = uni.getStorageSync(name);
    if (arr) return arr;else
    return null;
  },
  Clearsingle: function Clearsingle(_ref3) {var key = _ref3.key,data = _ref3.data,attr = _ref3.attr; //清除单个收藏
    var name = key + 'History';
    var arr = uni.getStorageSync(name);
...
/***/ 46:
/*!******************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/dayjs/dayjs.min.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 493:
/*!*****************************************************************************************!*\
  !*** E:/Users/七环/Desktop/HBuilder/youpin si/node_modules/uview-ui/libs/util/emitter.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
